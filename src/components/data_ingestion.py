    ...
    def split_data_as_train_test(self,dataframe: DataFrame) ->None:
        ...
        try:
            ...
            if dataframe.empty or len(dataframe) == 0:
                error_message = f"Dataframe is empty. Cannot perform train-test split. Please ensure data exists in MongoDB collection: {self.data_ingestion_config.collection_name}"
